...
macro_rules! test_pe437xx_addr {
    ($ic:ident, $name:ident) => {
        mod $name {
            ...
            use pe437xx::{asynch::spi::*, Address, Attenuation};

            // Not strictly necessary, but if embedded_hal_async stabilizes OutputPin, this will become async
            #[tokio::test]
            async fn test_init() {
                ...
                let addr = Address::new(0x05).expect("Known address was invalid");
            ...
            async fn test_set_attenuation() {
                ...
                ic.set_attenuation(att)
                    .await
                    .expect("Failed to set attenuation");
...
macro_rules! test_pe437xx_noaddr {
    ($ic:ident, $name:ident) => {
        mod $name {
            ...
            use pe437xx::{asynch::spi::*, Attenuation};
